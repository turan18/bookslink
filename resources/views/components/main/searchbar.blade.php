 <form method="GET" action='/search' class="text-white w-1/2">
        <input class="border-2 border-black-300 bg-white h-10 w-full px-3 pr-16 rounded-lg text-md focus:outline-none text-black font-bold font-salsa"
